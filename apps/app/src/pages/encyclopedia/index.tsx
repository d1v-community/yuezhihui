  ...
  const cards: KbCard[] = useMemo(
    () => [
      ...
      },
      {
        ...
        bullets: [
          '月经不是"排毒"，子宫内膜脱落是受激素控制的正常更新',
          '月经不是"废血"，由血液、子宫内膜碎片和阴道分泌物组成，并不"脏"',
          '月经不是越多越好，正常经量是每周期30-80mL，过多可能提示疾病',
          '月经颜色不是越红越好，偏暗红是正常的',
          '血块不是"血流太慢"，恰恰相反：血流太快时才更容易形成血块',
          '绝经不是突然"某天不来了"，有围绝经期过渡期',
          '月经相关不适不是"备孕的时候再治"，越早干预越好',
          '夜里一定要起夜换卫生巾不是常态，若经常如此可能月经量过多',
          '两小时内卫生巾浸满并不普通，属于月经过多的表现',
          '生活质量下降不是"忍忍就好"，忍耐不该是女性的默认选项',
        ],
        redFlags: ['疼痛越来越重，或止痛药效果越来越差', '疼痛导致无法正常上学/上班', '伴随经期外出血、发热、或异常分泌物'],
